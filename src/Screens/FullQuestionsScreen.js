  ...
  return (
    <>
      <div className="main-full">
        ...
        <div className="full-opacity-two"></div>
        ...
        <div className="question-info">
          ...
          <p>
            ...
            Mediante sus diferentes tipos de pólizas nos ayuda a estar
          ...
          <p>
            ...
            subsidio de costos de seguros médicos a través del Mercado de
          ...
          <p>
            ...
            costo. Con un plan tipo bronce, se beneficia de servicios de salud
            sin pagar ni un centavo. <br />
            <br />
