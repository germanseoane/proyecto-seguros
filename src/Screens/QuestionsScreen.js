        ...
        <div className="question-info">
          {question === OBAMACARE && (
            <>
              ...
              <p className="long-text">
                Obamacare asigna un subsidio a las familias para ayudarles a
                pagar su seguro médico. <br />
                <br />
                El seguro Obamacare es el mismo que el seguro privado, la
                diferencia entre Obama Care y un seguro privado es que si usted
                califica, se le otorga el subsidio para pagar parte del valor
                del seguro, mientras que en el seguro privado lo debe pagar por
                completo. <br />
                <br />
                Con el plan Obamacare usted no accede a un seguro de salud sino
                a un crédito fiscal del gobierno que subsidia los altos costos
                de los planes médicos privados, pudiendo acceder a los mismos.{" "}
                <br />
                <br />
                Si usted califica, se le otorga dicho subsidio para pagar parte
                del valor del seguro, mientras que en el seguro privado lo
                debería pagar usted por completo. <br />
                <br />
                ...
                calificar se toma en consideración la situación familiar, la
                edad, el hogar y los ingresos de cada cliente. <br />
                <br />
          ...
          {question === INSCRIPTION && (
            <>
              ...
              <p className="long-text">
                ...
                (Obamacare Open Enrollment) comienza el 1° de noviembre y
                finaliza el 15 de diciembre. Fuera de esos dos meses usted solo
                puede obtener una aseguranza médica con carácter excepcional.{" "}
                <br />
                <br />
                Tiene que haber perdido cobertura por su trabajo o por Medicaid
                o haber cambiado de estatus migratorio.
              </p>
            </>
          )}
          {question === QUALIFY && (
            <>
              <h1 className="shrink">
                Que requisitos necesito para calificar?
              </h1>
              <p className="long-text">
                ...
                <br />
                <br />
                _Aplicar durante el periodo de inscripción para Obamacare 2022
          ...
          {question === SERVICES && (
            <>
              ...
              <p className="long-text">
                ...
                <br />
                _Ingresos hospitalarios Permite la atención psicológica y
          ...
          {question === BENEFITS && (
            <>
              ...
              <p className="long-text">
                ...
                <br /> <br />
                Elimina los límites de vida y los límites anuales de cobertura
                en dólares. <br />
                <br />
          ...
          {question === COST && (
            <>
              ...
              <p className="long-text">
                Los precios de un seguro médico de Obamacare están entre los 0
                USD y los 75 USD. <br />
                <br />
                ...
                ingreso familiar, menor será el subsidio del gobierno en el
                seguro médico Obamacare. <br />
                <br />
                <br />
                ...
                obstante, siempre recomendamos aplicar para Obamacare en
                español.
                <br />
                <br />
                Si ya cuenta con la documentación necesaria visite nuestra
                agencia en 7216 SW 8th St Ste 5 Miami Fl 33144. De esta manera
                podrá comenzar el proceso de solicitud. <br />
                <br />
          ...
          {question === WHEN && (
            <>
              ...
              <p className="long-text">
                ...
                inscripción abierta, usted contará con cobertura a partir del 1
                de enero. <br />
                <br />
                En cambio, si ha ocurrido un cambio en su vida, y califica para
                una Inscripción Especial su cobertura estará vigente el día 1
                del mes siguiente. <br />
                <br />
                Solo a partir de esta fecha, usted podrá contar con los
                beneficios de su cobertura médica.
              </p>
            </>
          )}
